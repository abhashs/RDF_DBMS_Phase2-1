...
public class QuadrupleSort extends QuadrupleIterator implements GlobalConst
{
	   ...
	   Exception
  {
    ...
    QuadruplepnodeSplayPQ Q1 = new QuadruplepnodeSplayPQ(_sort_fld, sortFldType, order);
    QuadruplepnodeSplayPQ Q2 = new QuadruplepnodeSplayPQ(_sort_fld, sortFldType, order);
    ...
    while (true) {
      ...
      //! TEMPORARY FOR ERRORS, CHANGE BACK TO COMMENT/FIX
      comp_res = 0;
//      comp_res = QuadrupleUtils.CompareTupleWithValue(sortFldType, cur_node.tuple, _sort_fld, lastElem);  // need tuple_utils.java
...
//	QuadrupleUtils.SetValue(lastElem, cur_node.tuple, _sort_fld, sortFldType);
  ...
  private void MIN_VAL(Tuple lastElem, AttrType sortFldType) 
    ...
    default:
      ...
      throw new QuadrupleUnknowAttrType("Sort.java: don't know how to handle attrSymbol, attrNull");
    }
	      ...
	      ) throws IOException, SortException
  {
    ...
    Q = new QuadruplepnodeSplayPQ(sort_fld, in[sort_fld - 1], order);
