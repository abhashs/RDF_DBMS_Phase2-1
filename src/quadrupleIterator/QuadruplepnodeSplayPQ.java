...
public class QuadruplepnodeSplayPQ extends QuadruplepnodePQ
{
  ...
  */
   ...
   */  
  public QuadruplepnodeSplayPQ(int fldNo, AttrType fldType, TupleOrder order)
  {
    root = null;
    count = 0;
    fld_no   = fldNo;
   ...
   */
  public void enq(Quadruplepnode item) throws IOException, QuadrupleUnknowAttrType, QuadrupleUtilsException 
  {
    count ++;
