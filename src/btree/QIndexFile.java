 ...
 */
public abstract class QIndexFile 
{
  /**
   ...
   */
  abstract public void insert(final KeyClass data, final QID rid)
   ...
   * @exception IndexSearchException  index search failed
   */
  abstract public boolean Delete(final KeyClass data, final QID rid)  
