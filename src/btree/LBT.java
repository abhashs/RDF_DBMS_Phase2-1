 ...
 *
 */
public class LBT  implements GlobalConst{
  ...
  public static void printPage(PageId pageno, int keyType)
    ...
    {
      LBTSortedPage sortedPage=new LBTSortedPage(pageno, keyType);
      int i;
      i=0;
      if ( sortedPage.getType()==NodeType.INDEX ) {
        LBTIndexPage indexPage=new LBTIndexPage((Page)sortedPage, keyType);
        System.out.println("");
	  ...
	  i++;    
        ...
        LBTLeafPage leafPage=new LBTLeafPage((Page)sortedPage, keyType);
        System.out.println("");
   ...
   */
  public static void printBTree(LBTreeHeaderPage header) 
    throws IOException, 
	   ConstructPageException, 
	   IteratorException,
	   HashEntryNotFoundException,
  ...
  private static void _printTree(PageId currentPageId, String prefix, int i, 
	   ...
	   ReplacerException 
    {
      ...
      LBTSortedPage sortedPage=new LBTSortedPage(currentPageId, keyType);
      prefix=prefix+"       ";
      i++;
      if( sortedPage.getType()==NodeType.INDEX) {  
	LBTIndexPage indexPage=new LBTIndexPage((Page)sortedPage, keyType);
   ...
   *@exception ReplacerException  error from lower layer
   */
  public static void printAllLeafPages(LBTreeHeaderPage header) 
    throws IOException, 
	   ConstructPageException, 
	   IteratorException,
	   HashEntryNotFoundException,
