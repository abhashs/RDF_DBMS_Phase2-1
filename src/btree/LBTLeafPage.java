 ...
 */
public class LBTLeafPage extends LBTSortedPage {
   ...
   */
  public LBTLeafPage(PageId pageno, int keyType) 
    throws IOException, 
   ...
   *@exception ConstructPageException BTLeafPage constructor error
   */
  public LBTLeafPage(Page page, int keyType) 
    throws IOException, 
	   ConstructPageException
    {
      super(page, keyType);
   ...
   *@exception ConstructPageException BTLeafPage constructor error
   */
  public LBTLeafPage( int keyType) 
    throws IOException, 
	   ConstructPageException
    {
      super(keyType);
  ...
  public KeyDataEntry getFirst(LID rid) 
    throws  IteratorException
    {
      ...
      try {
        ...
        entry=LBT.getEntryFromBytes(getpage(), getSlotOffset(0), getSlotLength(0),
     ...
     throws  IteratorException
   {
	 ...
	 return null;
       ...
       entry=LBT.getEntryFromBytes(getpage(),getSlotOffset(i), getSlotLength(i),
                  keyType, NodeType.LEAF);
   ...
   */
  boolean redistribute(LBTLeafPage leafPage, LBTIndexPage parentIndexPage, 
	...
	if (direction ==-1) { // 'this' is the left sibling of leafPage
	  ...
	  if ( (getSlotLength(0) + available_space()+ 8) > ((MAX_SPACE-DPFIXED)/2)) {
            ...
            KeyDataEntry firstEntry;
            firstEntry=LBT.getEntryFromBytes(getpage(), getSlotOffset(0),
