 ...
 */
public abstract class LIndexFile 
{
  /**
   ...
   */
  abstract public void insert(final KeyClass data, final LID rid)
   ...
   * @exception IndexSearchException  index search failed
   */
  abstract public boolean Delete(final KeyClass data, final LID rid)  
